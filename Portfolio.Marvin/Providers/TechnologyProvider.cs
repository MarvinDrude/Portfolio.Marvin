...
public sealed class TechnologyProvider : ITechnologyProvider
{
   ...
   private static readonly Dictionary<TechnologyKind, Technology> _all = new Dictionary<TechnologyKind, Technology>()
   {
      ...
      [TechnologyKind.Css] = new (TechnologyKind.Css, "CSS", new TechnologyLogo("logo_css", "#1572b6", true)),
      ...
      [TechnologyKind.Blazor] = new (TechnologyKind.Blazor, "Blazor", new TechnologyLogo("logo_blazor", "#702af7", true))
   };
}